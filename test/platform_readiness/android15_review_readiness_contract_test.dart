...
void main() {
  test(
    'Android 20 release identity and modern Android package gates are exact',
    () {
      ...
      expect(workflow, contains('(( BUILD_NUMBER == 20 ))'));
      expect(workflow, isNot(contains('(( BUILD_NUMBER == 19 ))')));
      expect(workflow, contains('BIL_ANDROID_V20_AUDITED_SOURCE_SHA'));
      expect(workflow, contains('BIL_ANDROID_V20_STAGING_MANIFEST_SHA256'));
      expect(
        workflow,
        contains('BIL_ANDROID_V20_FROZEN_SOURCE_MANIFEST_2026-09-19.md'),
      );
