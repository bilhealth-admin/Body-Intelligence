...
void main() {
  test(
    'Android 23 release identity and modern Android package gates are exact',
    () {
      ...
      expect(workflow, contains('(( BUILD_NUMBER == 23 ))'));
      expect(workflow, isNot(contains('(( BUILD_NUMBER == 22 ))')));
      expect(workflow, contains('BIL_ANDROID_V23_AUDITED_SOURCE_SHA'));
      expect(workflow, contains('BIL_ANDROID_V23_STAGING_MANIFEST_SHA256'));
      expect(
        workflow,
        contains('BIL_ANDROID_V23_FROZEN_SOURCE_MANIFEST_2026-09-22.md'),
      );
