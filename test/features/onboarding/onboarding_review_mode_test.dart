...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await revealAiButton(tester, const Key('onboarding-enable-ai'));
      await tester.tap(find.byKey(const Key('onboarding-enable-ai')));
      await tester.pump();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await revealAiButton(tester, const Key('onboarding-decline-ai'));
      await tester.tap(find.byKey(const Key('onboarding-decline-ai')));
      await tester.pump();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.tap(find.byKey(const Key('onboarding-enable-ai')));
      await tester.tap(
        find.byKey(const Key('onboarding-enable-ai')),
        warnIfMissed: false,
      );
      await tester.pump();
