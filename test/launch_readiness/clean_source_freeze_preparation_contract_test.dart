...
void main() {
  ...
  test(
    'validator targets the current non-self-referential Android 23 manifest',
    () {
      const currentManifestPath =
          'docs/release/BIL_ANDROID_V23_FROZEN_SOURCE_MANIFEST_2026-09-22.md';
      ...
      expect(metadata.releaseBuildNumber, 23);
      expect(
      ...
      expect(manifestSource, contains('BIL_ANDROID_V23_AUDITED_SOURCE_SHA'));
      expect(
        manifestSource,
        contains('BIL_ANDROID_V23_STAGING_MANIFEST_SHA256'),
      );
