...
void main() {
  ...
  test('validator targets the current non-self-referential +8 manifest', () {
    ...
    expect(manifestSource, contains('BIL_PLUS8_AUDITED_SOURCE_SHA'));
    expect(manifestSource, contains('BIL_PLUS8_STAGING_MANIFEST_SHA256'));
