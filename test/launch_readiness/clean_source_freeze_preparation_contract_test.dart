...
void main() {
  ...
  test(
    'validator targets the current non-self-referential Android 26 manifest',
    () {
      ...
      expect(metadata.releaseBuildNumber, 26);
      expect(
      ...
      expect(manifestSource, contains('BIL_ANDROID_V26_AUDITED_SOURCE_SHA'));
      expect(
        manifestSource,
        contains('BIL_ANDROID_V26_STAGING_MANIFEST_SHA256'),
      );
