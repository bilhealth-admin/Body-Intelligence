...
legal.ar = {
  '/privacy': { eyebrow: 'مركز الثقة', title: 'سياسة الخصوصية', intro: 'توضح هذه السياسة كيف تتعامل BIL Health مع المعلومات الشخصية عند استخدام تطبيق BIL وميزاته السحابية والذكاء الاصطناعي والصحة المتصلة والموقع والدعم.', updated: '9 سبتمبر 2026', sections: [
