...
const ui = {
  en: {
    ...
    version: 'Version', effective: 'Effective', updated: 'Last updated', date: '29 August 2026', official: 'Official BIL Health document', contents: 'On this page',
  },
  ar: {
    product: 'المنتج', privacy: 'الخصوصية', support: 'الدعم', health: 'الصحة', supportCta: 'احصل على الدعم', language: 'English',
    version: 'الإصدار', effective: 'تاريخ السريان', updated: 'آخر تحديث', date: '29 أغسطس 2026', official: 'وثيقة رسمية من BIL Health', contents: 'في هذه الصفحة',
  },
};
  ...
  en: {
    '/privacy': {
      ...
      sections: [
        ...
        ['ai', 'AI, voice, and photos', '<p><b>AI Coach:</b> only after a separate opt-in, BIL sends the question and the bounded categories selected for that request—such as weight, goals and measurements; nutrition, meals, water and preferences; activity and training; sleep and habits; verified connected-health summaries; and up to 12 recent conversation turns—to <b>Google Gemini, a third-party AI service operated by Google</b>, to generate the requested answer. Voice capture starts only after you press the microphone. Apple or another platform speech service may convert that initiated audio under its own terms; BIL and Google Gemini receive the recognized text, not raw microphone audio, from the current app.</p><p><b>Meal-photo analysis:</b> after a separate consent prompt, BIL sends the image you select, app language and necessary technical request metadata to Google Gemini to suggest foods and portions for your review. Nothing is added to the diary until you confirm it. You may decline either AI consent and continue using available local/manual features. Withdraw AI Coach consent in AI Coach settings and meal-photo consent in Privacy settings; withdrawal stops new transmissions. BIL retains limited AI usage, cost, security and reliability metadata, but does not add the submitted photo to a meal record unless you separately confirm the result. Provider processing is subject to BIL’s configured processor terms. AI can be wrong and is not medical advice.</p>'],
    ...
    '/terms': {
      ...
      sections: [
        ...
        ['ai', 'AI and calculated information', '<p>AI responses, calorie estimates, nutrient matches, trend explanations, and connected-device readings may be incomplete or wrong. Confidence indicators are not guarantees. Automated safety controls may block an AI prompt or candidate reply; a block is not a clinical assessment, no provider answer is shown or spoken, and the rejected message is not charged. Review inputs and outputs, use qualified professionals for medical decisions, and never rely on BIL to dose medicine or manage an emergency.</p>'],
    ...
    '/health-disclaimer': {
      ...
      sections: [
        ...
        ['ai', 'AI Coach boundary', '<p>A local urgent-symptom guard runs before remote AI. AI may misunderstand language, context, or evidence. Gemini safety filters may block a prompt or candidate reply; when blocked, no provider answer is shown or spoken, the message is not charged, and the app asks you to rephrase without hiding important symptoms. A block is not a medical assessment. AI may provide general education and help organize your own plan, but it must not be treated as a clinician and does not execute actions without your approval. For immediate danger, severe symptoms, or risk of self-harm, contact local emergency services now.</p>'],
    ...
    '/community-guidelines': {
      ...
      sections: [
        ...
        ['report', 'Report, block, and urgent risk', `<p>Use the in-app report and block controls for content, messages, or member behavior that may break these rules. Blocking is a safety boundary and must not be evaded. You may also email <a href="mailto:${SUPPORT_EMAIL}">${SUPPORT_EMAIL}</a> with the account or content reference and a concise explanation. Do not send passwords, verification codes, or raw health exports. For immediate danger, contact local emergency services; BIL is not an emergency channel.</p>`],
        ['moderation', 'Human moderation and enforcement', '<p>Authorized human moderators review submitted posts and reports. Automated safety filters may prevent clearly restricted content from being submitted, but they support rather than replace human judgment. BIL may hold or limit visibility, reject or remove content, suspend community features, or restrict accounts to enforce these rules, protect users, comply with law, or investigate abuse. Review decisions consider context, severity, repetition, and credible risk. Where appropriate, users may request another review through support.</p>'],
        ['privacy', 'Privacy and health information', `<p>Community content may be visible to the audience selected in the app. Private messages are access-controlled but are not end-to-end encrypted. Share only the minimum information needed for a supportive conversation; never publish another person’s health data, identity, or location, and avoid posting your own sensitive health information. Privacy or deletion requests may be sent to <a href="mailto:${PRIVACY_EMAIL}">${PRIVACY_EMAIL}</a>.</p>`],
      ],
    },
    '/contact': {
...
legal.ar = {
  '/privacy': { eyebrow: 'مركز الثقة', title: 'سياسة الخصوصية', intro: 'توضح هذه السياسة كيف تتعامل BIL Health مع المعلومات الشخصية عند استخدام تطبيق BIL وميزاته السحابية والذكاء الاصطناعي والصحة المتصلة والموقع والدعم.', updated: '24 سبتمبر 2026', sections: [
    ...
    ['ai','الذكاء والصوت والصور','<p><b>مدرب BIL:</b> بعد موافقة منفصلة فقط، يرسل BIL السؤال والفئات المحددة اللازمة للطلب—مثل الوزن والأهداف والقياسات؛ والتغذية والوجبات والماء والتفضيلات؛ والنشاط والتدريب؛ والنوم والعادات؛ وملخصات الصحة المتصلة الموثقة؛ وما يصل إلى آخر 12 رسالة—إلى <b>Google Gemini، وهي خدمة ذكاء اصطناعي تابعة لجهة خارجية وتديرها Google</b>، لإنشاء الإجابة المطلوبة. يبدأ التقاط الصوت بعد ضغط الميكروفون؛ وقد تحول خدمة Apple أو المنصة الصوت إلى نص وفق شروطها، بينما يستلم BIL وGoogle Gemini النص المتعرف عليه لا الصوت الخام.</p><p><b>تحليل صورة الوجبة:</b> بعد موافقة منفصلة، يرسل BIL الصورة التي تختارها ولغة التطبيق وبيانات الطلب التقنية الضرورية إلى Google Gemini لاقتراح أطعمة وحصص تراجعها. لا يُضاف شيء إلى اليوميات حتى تؤكد النتيجة. يمكنك رفض أي من الموافقتين ومتابعة الميزات المحلية أو الإدخال اليدوي المتاح. اسحب موافقة المدرب من إعداداته وموافقة الصور من إعدادات الخصوصية لإيقاف الإرسال الجديد. يحتفظ BIL ببيانات تشغيل محدودة للاستخدام والتكلفة والأمان والموثوقية، ولا يضيف الصورة المقدمة إلى سجل وجبة ما لم تؤكد النتيجة بشكل منفصل. تخضع معالجة المزود لشروط المعالج المهيأة لدى BIL. قد يخطئ الذكاء ولا يُعد نصيحة طبية.</p>'],
  ...
  '/terms': { eyebrow: 'قانوني', title: 'شروط الاستخدام', intro: 'تنظم هذه الشروط استخدام BIL. باستخدام التطبيق أو الموقع توافق على الاستخدام المسؤول ضمن حدود الصحة والأمان التالية.', updated: '9 سبتمبر 2026', sections: [
    ...
    ['ai','الذكاء والحسابات','<p>قد تخطئ إجابات الذكاء وتقديرات السعرات والمغذيات والاتجاهات والأجهزة. قد تحجب ضوابط الأمان الآلية سؤالًا أو إجابة مرشحة؛ والحجب ليس تقييمًا سريريًا، ولا تظهر عنده إجابة من المزود ولا تُنطق، ولا تُحتسب الرسالة المرفوضة. راجع المصدر والوحدة والحصة والثقة، ولا تستخدم BIL لجرعات الدواء أو الطوارئ.</p>'],
  ...
  '/health-disclaimer': { eyebrow: 'السلامة أولًا', title: 'إخلاء المسؤولية الصحي', intro: 'يدعم BIL العافية العامة وفهم الذات، ولا يستبدل مهنيًا صحيًا مؤهلًا أو خدمة طوارئ.', updated: '9 سبتمبر 2026', sections: [
  ...
  '/community-guidelines': { eyebrow: 'سلامة المجتمع', title: 'إرشادات المجتمع', intro: 'مساحات مجتمع BIL مخصصة لدعم الصحة واللياقة باحترام بين البالغين. توضح هذه السياسة قواعد كل تفاعل مجتمعي، وكيفية الإبلاغ عن الضرر، وكيف يستخدم BIL الإشراف البشري.', version: 'community-policy-v1', effective: '8 سبتمبر 2026', updated: '23 سبتمبر 2026', sections: [
    ...
    ['report','الإبلاغ والحظر والخطر العاجل',`<p>استخدم أدوات الإبلاغ والحظر داخل التطبيق للمحتوى أو الرسائل أو سلوك الأعضاء الذي قد يخالف هذه القواعد. الحظر حدّ أمان ويُمنع التحايل عليه. ويمكنك أيضًا مراسلة <a href="mailto:${SUPPORT_EMAIL}">${SUPPORT_EMAIL}</a> مع مرجع الحساب أو المحتوى وشرح مختصر. لا ترسل كلمات مرور أو رموز تحقق أو تصديرًا صحيًا خامًا. عند وجود خطر فوري اتصل بخدمات الطوارئ المحلية؛ BIL ليس قناة طوارئ.</p>`],
    ['moderation','الإشراف البشري والتنفيذ','<p>يراجع مشرفون بشريون مخولون المنشورات والبلاغات المقدمة. قد تمنع فلاتر الأمان الآلية إرسال المحتوى المقيد بوضوح، لكنها تدعم الحكم البشري ولا تستبدله. قد يحتجز BIL المحتوى أو يحد ظهوره أو يرفضه أو يزيله أو يعلّق ميزات المجتمع أو يقيّد الحسابات لتطبيق القواعد أو حماية المستخدمين أو الامتثال للقانون أو التحقيق في الإساءة. تراعي قرارات المراجعة السياق والخطورة والتكرار والمخاطر الموثوقة، ويمكن طلب مراجعة أخرى عبر الدعم عند الاقتضاء.</p>'],
    ['privacy','الخصوصية والمعلومات الصحية',`<p>قد يظهر محتوى المجتمع للجمهور الذي تحدده في التطبيق. الرسائل الخاصة محمية بعناصر تحكم في الوصول لكنها ليست مشفرة من طرف إلى طرف. شارك الحد الأدنى اللازم لمحادثة داعمة؛ ولا تنشر أبدًا بيانات شخص آخر الصحية أو هويته أو موقعه، وتجنب نشر معلوماتك الصحية الحساسة. لطلبات الخصوصية أو الحذف راسل <a href="mailto:${PRIVACY_EMAIL}">${PRIVACY_EMAIL}</a>.</p>`],
  ]},
...
function renderDocument(page, lang) {
  ...
  const version = page.version ? `<span>${copy.version}: ${page.version}</span>` : '';
  const effective = page.effective ? `<span>${copy.effective}: ${page.effective}</span>` : '';
  return `<div class="page-shell"><header class="page-hero"><span class="eyebrow">${page.eyebrow}</span><h1>${page.title}</h1><p>${page.intro}</p><div class="document-meta"><span>${copy.official}</span>${version}${effective}<span>${copy.updated}: ${page.updated || copy.date}</span><span>bilhealth.com</span></div></header><div class="document-layout"><aside class="toc" aria-label="${copy.contents}"><strong>${copy.contents}</strong>${toc}</aside><article class="document">${content}</article></div></div>`;
}
