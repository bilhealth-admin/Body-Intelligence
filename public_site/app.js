...
const ui = {
  en: {
    ...
    updated: 'Last updated', date: '27 August 2026', official: 'Official BIL Health document', contents: 'On this page',
  },
  ar: {
    product: 'المنتج', privacy: 'الخصوصية', support: 'الدعم', health: 'الصحة', supportCta: 'احصل على الدعم', language: 'English',
    updated: 'آخر تحديث', date: '27 أغسطس 2026', official: 'وثيقة رسمية من BIL Health', contents: 'في هذه الصفحة',
  },
};
  ...
  en: {
    '/privacy': {
      ...
      sections: [
        ...
        ['data', 'Information we process', '<ul><li><b>Account:</b> email address, optional display name, account identifier, authentication and security events.</li><li><b>Health and wellness:</b> profile details, age range or date of birth, biological sex where supplied, nutrition, meals, water, weight, measurements, activity, sleep, symptoms, goals, and notes.</li><li><b>Connected sources:</b> records you authorize through HealthKit or Health Connect, plus weight, body-composition, and heart-rate readings from compatible external Bluetooth fitness devices.</li><li><b>User content:</b> AI questions, meal photos, voice input or transcripts, feedback, community submissions, and support messages you choose to send.</li><li><b>Commerce and technical data:</b> store product, entitlement and receipt-verification results, language, app version, device platform, security diagnostics, and limited operational logs. When contextual free-tier ads operate, Google Mobile Ads automatically collects and shares IP address (which may estimate general location), product interactions, diagnostics, and device/account identifiers for advertising, analytics, and fraud prevention. BIL does not receive your full payment-card number.</li></ul>'],
        ['collection', 'How data reaches BIL', '<p>Most information is entered by you or imported only after a platform permission. The local-first diary works without a cloud account. Cloud synchronization, remote AI, image analysis, purchases, push notifications, community tools, and device connections activate only when configured and requested.</p>'],
        ...
        ['ai', 'AI, voice, and photos', '<p>Remote AI is opt-in. Only the context needed for the requested answer is sent through BIL-controlled gateways to configured model providers such as Google Gemini. Voice capture starts only after you press the microphone; audio or a transcript is used to answer your request. Meal photos are sent only after you choose image analysis. AI can be wrong and must not be treated as medical advice.</p>'],
        ['sharing', 'Processors and disclosure', '<p>BIL may use Supabase for authenticated cloud storage and server functions; Apple or Google for distribution, billing, and connected-health permissions; Google Gemini for requested remote AI processing; and Google Mobile Ads for contextual, non-personalized free-tier ads when enabled. Google Mobile Ads processes the advertising data categories described above; it must never receive BIL health, nutrition, weight, profile, search, location, or AI-conversation content for targeting. Health data is not sold, shared with data brokers, or used to target ads. We may disclose limited information when legally required or to protect users and the service.</p>'],
        ['retention', 'Retention and deletion', '<p>Local records remain until you delete them or the app data. Cloud records remain while your account and the related feature are active, then are deleted or de-identified according to the deletion workflow, backups, fraud-prevention needs, and legal retention duties. AI and operational logs are minimized. Store transaction records may remain with Apple or Google under their rules.</p>'],
        ...
        ['security', 'Security and international processing', '<p>BIL uses encrypted transport, platform-protected credentials, access controls, row-level authorization, redacted diagnostics, and verified server boundaries. No system is perfectly secure. Cloud providers may process data in countries outside yours under contractual and legal safeguards appropriate to the service.</p>'],
    ...
    '/account-deletion': {
      ...
      sections: [
        ['in-app', 'Fastest: request deletion in the app', '<ol><li>Sign in to the BIL account you want to delete.</li><li>Open <b>More → Settings → Delete account</b>.</li><li>Review the consequences, type <b>DELETE</b>, and submit.</li><li>Keep the request reference shown by BIL.</li></ol>'],
        ...
        ['retention', 'Verification, retention, and status', '<p>Deletion requests enter a tracked pending or processing state. BIL may retain the minimum records required for security, fraud prevention, transaction disputes, tax, or other law, then delete them when the obligation ends. Backups age out under controlled retention. BIL will not keep data merely to avoid deletion.</p>'],
        ['subscriptions', 'Cancel billing separately', '<p>Account deletion does not automatically cancel a subscription managed by Apple or Google. Cancel it in the applicable store first. You may also use Restore Purchases before deletion if you need to confirm the account being removed.</p>'],
      ],
    },
    '/data-deletion': {
    ...
    '/health-disclaimer': {
      ...
      sections: [
        ...
        ['emergency', 'Not for emergencies', '<p>Do not use BIL for urgent symptoms, medication dosing, glucose or oxygen emergencies, eating-disorder crisis care, pregnancy complications, or decisions requiring clinical judgment. Contact local emergency services or a qualified professional.</p>'],
        ...
        ['devices', 'Connected devices', '<p>BIL displays records from supported phones, platforms, watches, scales, and medical-device interfaces only after permission and connection. It does not guarantee hardware accuracy or compatibility. Follow the device manufacturer’s instructions.</p>'],
...
legal.ar = {
  '/privacy': { eyebrow: 'مركز الثقة', title: 'سياسة الخصوصية', intro: 'توضح هذه السياسة كيف تتعامل BIL Health مع المعلومات الشخصية عند استخدام تطبيق BIL وميزاته السحابية والذكاء الاصطناعي والصحة المتصلة والموقع والدعم.', sections: [
    ...
    ['data','البيانات التي نعالجها','<ul><li><b>الحساب:</b> البريد الإلكتروني والاسم الاختياري ومعرّف الحساب وأحداث الأمان.</li><li><b>الصحة والعافية:</b> الملف الشخصي والعمر والجنس البيولوجي عند إدخاله والتغذية والوجبات والماء والوزن والقياسات والنشاط والنوم والأهداف والملاحظات.</li><li><b>المصادر المتصلة:</b> السجلات التي تسمح بها من HealthKit أو Health Connect، إضافة إلى الوزن وتركيب الجسم ونبض القلب من أجهزة لياقة Bluetooth خارجية متوافقة.</li><li><b>محتواك:</b> أسئلة الذكاء والصور والصوت أو النص والملاحظات والمشاركات التي ترسلها.</li><li><b>التجارة والتقنية:</b> المنتج والاستحقاق ونتيجة التحقق من الشراء والمنصة واللغة وإصدار التطبيق وسجلات تشغيل محدودة. عند تشغيل إعلانات الفئة المجانية السياقية، تجمع Google Mobile Ads وتشارك تلقائيًا عنوان IP الذي قد يقدّر الموقع العام، وتفاعلات المنتج، وبيانات التشخيص، ومعرّفات الجهاز أو الحساب لأغراض الإعلان والتحليلات ومنع الاحتيال. لا يستلم BIL رقم بطاقتك الكامل.</li></ul>'],
    ['collection','كيف تصل البيانات','<p>تأتي معظم البيانات منك أو بعد إذن واضح من النظام. تعمل اليوميات الأساسية محليًا دون حساب. لا تعمل المزامنة والذكاء البعيد وتحليل الصور والمشتريات والإشعارات والمجتمع والأجهزة إلا عند تهيئتها وطلبها.</p>'],
    ...
    ['ai','الذكاء والصوت والصور','<p>الذكاء البعيد اختياري. يُرسل فقط السياق اللازم عبر بوابات BIL إلى مزود مهيأ مثل Google Gemini. يبدأ الصوت بعد ضغط الميكروفون فقط، ولا تُرسل صورة الوجبة إلا بعد اختيار التحليل. قد يخطئ الذكاء ولا يُعد نصيحة طبية.</p>'],
    ['sharing','المعالجون والمشاركة','<p>قد يستخدم BIL: Supabase للتخزين السحابي الآمن، وApple أو Google للتوزيع والدفع والأذونات الصحية، وGoogle Gemini لطلبات الذكاء، وGoogle Mobile Ads لإعلانات سياقية غير مخصصة للفئة المجانية عند تفعيلها. تعالج Google Mobile Ads فئات بيانات الإعلان الموضحة أعلاه، ولا يجوز أن تتلقى محتوى الصحة أو التغذية أو الوزن أو الملف أو البحث أو الموقع أو محادثات الذكاء من BIL للاستهداف. لا تُباع البيانات الصحية ولا تُستخدم لاستهداف الإعلانات.</p>'],
    ['retention','الاحتفاظ والحذف','<p>تبقى البيانات المحلية حتى تحذفها. تبقى السجلات السحابية أثناء نشاط الحساب والميزة، ثم تُحذف أو تُزال هويتها وفق مسار الحذف والنسخ الاحتياطية ومتطلبات الأمان والقانون. قد يحتفظ Apple أو Google بسجلات المتجر وفق سياساتهما.</p>'],
    ...
    ['security','الأمان والمعالجة الدولية','<p>نستخدم اتصالًا مشفرًا وحماية مفاتيح النظام وضوابط وصول وعزل صفوف البيانات وتشخيصات منقحة وحدود خادم موثقة. لا يوجد نظام آمن بالكامل. قد يعالج المزودون البيانات خارج بلدك وفق ضمانات تعاقدية وقانونية مناسبة.</p>'],
  ...
  '/account-deletion': { eyebrow: 'تحكمك', title: 'حذف حساب BIL', intro: 'يمكنك بدء الحذف من داخل BIL أو عبر طلب إلكتروني. حذف التطبيق وحده لا يحذف الحساب السحابي.', sections: [
    ['in-app','الأسرع: من داخل التطبيق','<ol><li>سجل الدخول للحساب المطلوب.</li><li>افتح <b>المزيد ← الإعدادات ← حذف الحساب</b>.</li><li>راجع النتائج واكتب <b>DELETE</b> ثم أرسل.</li><li>احتفظ برقم مرجع الطلب.</li></ol>'],
    ...
    ['retention','التحقق والاحتفاظ والحالة','<p>يدخل الطلب حالة معلّق أو قيد المعالجة مع رقم مرجعي. قد نحتفظ بالحد الأدنى اللازم للأمان أو الاحتيال أو نزاع الشراء أو القانون ثم نحذفه عند انتهاء الالتزام.</p>'],
    ['subscriptions','ألغِ الفوترة بشكل منفصل','<p>حذف الحساب لا يلغي تلقائيًا اشتراكًا تديره Apple أو Google. ألغِه من المتجر أولًا.</p>'],
  ]},
  ...
  '/health-disclaimer': { eyebrow: 'السلامة أولًا', title: 'إخلاء المسؤولية الصحي', intro: 'يدعم BIL العافية العامة وفهم الذات، ولا يستبدل مهنيًا صحيًا مؤهلًا أو خدمة طوارئ.', sections: [
    ...
    ['emergency','ليس للطوارئ','<p>لا تستخدمه للأعراض العاجلة أو جرعات الدواء أو طوارئ السكر والأكسجين أو الحمل أو اضطرابات الأكل أو قرار يحتاج حكمًا سريريًا. اتصل بخدمة الطوارئ المحلية.</p>'],
    ...
    ['devices','الأجهزة المتصلة','<p>يعرض BIL السجلات بعد الإذن والاتصال فقط، ولا يضمن دقة الجهاز أو توافقه. اتبع تعليمات الشركة المصنعة.</p>'],
