...
const nutritionPathwayTranslations = <String, Map<String, NutritionPathwayTranslation>>{
  'fr': {
    'carb-cycling': NutritionPathwayTranslation(
      'Cycle des glucides',
      'Des glucides différents chaque jour, des calories fixes et un équilibre protéines-lipides en direct',
      ['Cycle hebdomadaire', 'Calories fixes', 'Modifiable'],
      [
        'Associer les jours plus riches en glucides aux entraînements plus exigeants',
        'Modifier chaque jour séparément du lundi au dimanche',
        'Garder les calories fixes pendant que BIL rééquilibre protéines et lipides',
      ],
      [
        'Glucides quotidiens',
        'Performance et récupération',
        'Adhésion hebdomadaire',
      ],
    ),
    ...
    'lean-mass': NutritionPathwayTranslation(
      ...
      ['Performance', 'Tendance du poids', 'Tour de taille et récupération'],
    ),
  ...
  'es': {
    'carb-cycling': NutritionPathwayTranslation(
      ...
      'Carbohidratos distintos cada día con calorías fijas y equilibrio dinámico de proteína y grasa',
      ['Ciclo semanal', 'Calorías fijas', 'Editable'],
      [
        'Relacionar los días altos en carbohidratos con los entrenamientos más exigentes',
        'Editar cada día por separado de lunes a domingo',
        'Mantener las calorías mientras BIL reequilibra proteína y grasa',
      ],
      [
    ...
    'cutting': NutritionPathwayTranslation(
      ...
      ['Tendencia del peso', 'Fuerza y recuperación', 'Hambre y adherencia'],
    ),
    'lean-mass': NutritionPathwayTranslation(
    ...
    'pregnancy': NutritionPathwayTranslation(
      ...
      ['Consejo clínico', 'Seguridad alimentaria', 'Suficiencia del registro'],
    ),
    'psmf': NutritionPathwayTranslation(
  ...
  'tr': {
    'carb-cycling': NutritionPathwayTranslation(
      ...
      'Her gün farklı karbonhidrat, sabit kalori ve canlı protein-yağ dengesi',
      ['Haftalık döngü', 'Sabit kalori', 'Düzenlenebilir'],
      [
        'Yüksek karbonhidrat günlerini gerektiğinde daha zorlu antrenmanlarla eşleştirin',
        'Pazartesiden pazara her günü ayrı düzenleyin',
        'Kaloriyi sabit tutarken protein ve yağı BIL ile yeniden dengeleyin',
      ],
      ['Günlük karbonhidrat', 'Performans ve toparlanma', 'Haftalık uyum'],
    ),
    'cutting': NutritionPathwayTranslation(
      'Akıllı yağ kaybı',
