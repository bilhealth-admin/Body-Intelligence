...
abstract final class AccessibilityWellnessRuntimeCopy {
  ...
  static const values = <String, Map<String, String>>{
    ...
    'Health sources & methodology': {
      'ar': 'مصادر الصحة والمنهجية',
      'en': 'Health sources & methodology',
      'fr': 'Sources de santé et méthodologie',
      'es': 'Fuentes de salud y metodología',
      'tr': 'Sağlık kaynakları ve yöntem',
      'de': 'Gesundheitsquellen und Methodik',
      'it': 'Fonti sulla salute e metodologia',
      'pt-BR': 'Fontes de saúde e metodologia',
      'pt-PT': 'Fontes de saúde e metodologia',
      'ur': 'صحت کے ذرائع اور طریقۂ کار',
      'fa': 'منابع سلامت و روش‌شناسی',
      'hi': 'स्वास्थ्य स्रोत और कार्यप्रणाली',
      'id': 'Sumber kesehatan dan metodologi',
      'ms': 'Sumber kesihatan dan metodologi',
      'ja': '健康情報の出典と方法',
      'ko': '건강 출처 및 방법론',
      'zh-Hans': '健康来源与方法',
      'zh-Hant': '健康來源與方法',
      'ru': 'Источники о здоровье и методология',
      'bn': 'স্বাস্থ্য উৎস ও পদ্ধতি',
      'vi': 'Nguồn sức khỏe và phương pháp',
      'th': 'แหล่งข้อมูลสุขภาพและระเบียบวิธี',
      'pl': 'Źródła zdrowotne i metodologia',
      'nl': 'Gezondheidsbronnen en methodologie',
      'uk': 'Джерела про здоров’я та методологія',
    },
    'Read answer aloud': {
