...
abstract final class BilTypography {
  static TextTheme build({
    ...
    final displayFamily = isArabic ? 'IBM Plex Sans Arabic' : 'Manrope';
    final bodyFamily = isArabic ? 'IBM Plex Sans Arabic' : 'Manrope';
  ...
  static TextTheme compact({
    ...
    return build(
      ...
      displayLarge: build(
        ...
        foreground: foreground,
        isArabic: isArabic,
      ).displayLarge?.copyWith(fontSize: 48),
      displayMedium: build(
        base: base,
        foreground: foreground,
        isArabic: isArabic,
      ).displayMedium?.copyWith(fontSize: 40),
      displaySmall: build(
        base: base,
        foreground: foreground,
        isArabic: isArabic,
      ).displaySmall?.copyWith(fontSize: 34),
      headlineLarge: build(
        base: base,
        foreground: foreground,
        isArabic: isArabic,
      ).headlineLarge?.copyWith(fontSize: 30),
    );
  }
}
