...
> **BIL compatibility fork:** this vendored copy supports only unencrypted
> archives. ZIP password encryption/decryption and XZ SHA-256 checks are
> deliberately disabled and fail closed; their former embedded crypto
> implementations are not shipped.
